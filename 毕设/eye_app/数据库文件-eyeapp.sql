...
#
# Table structure for table test_astigmatism
#

DROP TABLE IF EXISTS `test_astigmatism`;
CREATE TABLE `test_astigmatism` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `astigmatism_rate` int(4) DEFAULT NULL COMMENT '散光几率',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='测试记录--散光测试记录表';
INSERT INTO `test_astigmatism` VALUES (1,1,50,'2015-05-05',50);
/*!40000 ALTER TABLE `test_astigmatism` ENABLE KEYS */;
UNLOCK TABLES;

#
# Table structure for table test_colorbind
#

DROP TABLE IF EXISTS `test_colorbind`;
CREATE TABLE `test_colorbind` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `u_id` int(11) DEFAULT NULL COMMENT '测试者的id',
  `correct_rate` int(4) DEFAULT NULL COMMENT '正确率：0%-100%',
  `date` datetime DEFAULT NULL COMMENT '本次测试的时间',
  `colorbind_rate` int(4) DEFAULT NULL COMMENT '测试结果：患色盲几率，0%-100%',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='测试记录--色盲测试记录表';
INSERT INTO `test_colorbind` VALUES (1,1,50,'2015-02-05',50);
/*!40000 ALTER TABLE `test_colorbind` ENABLE KEYS */;
UNLOCK TABLES;
...
#
# Table structure for table test_sensitivity
#

DROP TABLE IF EXISTS `test_sensitivity`;
CREATE TABLE `test_sensitivity` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `u_id` int(11) DEFAULT NULL COMMENT '测试者的id',
  `correct_rate` int(4) DEFAULT NULL COMMENT '正确率：0%-100%',
  `date` datetime DEFAULT NULL COMMENT '本次测试的时间',
  `sensitivity_num` int(4) DEFAULT NULL COMMENT '敏感度：0-100',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='测试记录--敏感度测试记录表';
INSERT INTO `test_sensitivity` VALUES (1,1,50,'2018-06-02',80);
/*!40000 ALTER TABLE `test_sensitivity` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `test_vision`;
CREATE TABLE `test_vision` (
  ...
  `visoin_num` double(4,2) DEFAULT NULL COMMENT '视力测试结果，标准视力表取值范围',
  `myopia_num` int(6) DEFAULT NULL COMMENT '近视度数，没近视则取值0',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='测试记录--明视距离测试记录表';
INSERT INTO `test_vision` VALUES (1,1,50,'2014-02-03','左',4.5,500);
/*!40000 ALTER TABLE `test_vision` ENABLE KEYS */;
UNLOCK TABLES;
